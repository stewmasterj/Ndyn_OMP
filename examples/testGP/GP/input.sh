...
Types 4  #atom and particle types
 Cu2  1016.736 0.0 # name mass charge
 Cu1   63.546 0.0 # name mass charge
 Cu-1 1016.736 0.0 # name mass charge
...
Pairs 6
 ...
 Cu1  Cu-2 asym spring 3.0 34.364e-3 0.5 99.672064 #rc c s0 Vi
 Cu-2 Cu2  asym Morse  12.0  5.4864 0.6795 5.732
 Cu2  Cu-1 asym spring 6.0  2.152295e-3 0.5 12.459008 #rc c s0 Vi
...
Isokinetic      0.0 0.1 2 #enforce strict low temperatures
InitPos
Run             2000 0.1
Anisobaric      #unset the barostat (constant volume)
# run 2 NVT with initial velocity distribution
Velocity        0.03877798635 S1 #3/2*k*300K, k=8.6173303e-5 eV/K
Velocity        0.03877798635 S2 #3/2*k*300K, k=8.6173303e-5 eV/K
#Velocity        0.3102238908 S2 #3/2*k*300K, k=8.6173303e-5 eV/K
Isokinetic      0.03877798635 0.1 10
#ReNeighbor      T #might need this if skin is too small
#InitPos
Run             2000 0.1    # run for [i] steps each at [r] deltat
# run 3 NPT
Isobaric        0.0 0.0 0.0  1.0 10
#InitPos
Run             4000 0.1
