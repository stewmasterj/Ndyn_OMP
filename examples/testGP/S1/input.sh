...
###################
BoxSize 87.096 43.548 43.548 # 12*2*a0, 6*2*a0, 6*2*a0
...
# Cu2  508.368 0.0 # name mass charge
# Cu-1  63.546 0.0 # name mass charge
# Cu-2 508.368 0.0 # name mass charge
...
# Cu2  Cu2   sym Morse  12.0  2.7432 0.6795 5.732
